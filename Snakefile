...
rule all:
    input:
        ...
        lookup_psql = join(config['path']['psql'],
                           config['psql']['lookup'],
                           'data_table.tsv'),
        rRNA_alignment_specie_psql = join(config['path']['psql'],
                                          config['psql']['rRNA_alignment_specie'],
                                          'data_table.tsv'),
        rRNA_alignment_modification_psql = join(config['path']['psql'],
                                                 config['psql']['rRNA_alignment_modification'],
                                                 'data_table.tsv'),
        rRNA_alignment_sequence_psql = join(config['path']['psql'],
