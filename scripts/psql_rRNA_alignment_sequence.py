...
file = snakemake.input.alignment_data

psql_script = snakemake.output.alignment_script
psql_data = snakemake.output.alignment_psql
...
def create_psql_script():
    ...
    del_table = 'DROP TABLE IF EXISTS "rRNA_alignment_sequence";\n\n'
    create_table = """
CREATE TABLE "rRNA_alignment_sequence" (
    ...
    """
    import_data = """
\\copy "rRNA_alignment_sequence" (unique_id, aligned_sequence) FROM '/sql/data_table.tsv' WITH (DELIMITER E'\\t', NULL '');
    """
