...
file = snakemake.input.conversion_18S

psql_data = snakemake.output.conversion_18S_psql
psql_script = snakemake.output.conversion_18S_script
...
def create_psql_script():
    ...
    del_table = 'DROP TABLE IF EXISTS "conversion_18S";\n\n'
    create_table = """
CREATE TABLE "conversion_18S" (
    ...
    base_zavolan varchar(1)
);
    """
    import_data = """
\\copy "conversion_18S" (pos_snoRNABase, pos_incarnato, pos_snOPY, base_snoRNABase, base_incarnato, base_zavolan) \
...
def main():
    ...
    df.snOPY_seq = df.snOPY_seq.str.replace('T', 'U')
